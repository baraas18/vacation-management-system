...
router.post('/:userId([0-9a-fA-F-]+)', addImageToBody, validate(addVacationValidator), uploadImage, add)
router.put('/:id([0-9a-fA-F-]+)/:userId([0-9a-fA-F-]+)', addImageToBody, validate(putVacationValidator), uploadImage, update)
router.patch('/:id([0-9a-fA-F-]+)/:userId([0-9a-fA-F-]+)', addImageToBody, validate(patchVacationValidator), uploadImage, patch)
